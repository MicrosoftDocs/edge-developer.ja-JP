...
*   Windows フォーム アプリの構築の詳細については[、「Windows][Webview2GettingstartedWinforms]フォームの概要ガイド」および「Windows フォーム固有 API の[WebView2][DotnetApiMicrosoftWebWebview2Winforms] Windows フォーム リファレンス」に移動します。  
...
[Webview2GettingstartedWinforms]: ./gettingstarted/winforms.md "フォーム アプリの WebView2 のWindows開始|Microsoft Docs"  
