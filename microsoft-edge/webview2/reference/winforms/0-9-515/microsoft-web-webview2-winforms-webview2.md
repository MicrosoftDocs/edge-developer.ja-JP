...
Assembly: WinForms (WebView2 の場合)
...
これは、CoreWebView2 の Executesメソッドと同じです。 基になる CoreWebView2 がまだ初期化されていない場合、このメソッドは InvalidOperationException をスローします。 詳細については、CoreWebView2 のマニュアルを参照してください。
