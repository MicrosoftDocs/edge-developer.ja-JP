...
---
# 0.9.579-インターフェイス ICoreWebView2NewBrowserVersionAvailableEventHandler 
...
> パブリック HRESULT [呼び出し](#invoke)([ICoreWebView2Environment](icorewebview2environment.md) * Webviewenvironment、IUnknown * args)
