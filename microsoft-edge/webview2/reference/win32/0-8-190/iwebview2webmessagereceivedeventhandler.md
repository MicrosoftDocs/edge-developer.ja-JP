...
---
# 0.8.355-インターフェイス IWebView2WebMessageReceivedEventHandler 
...
> パブリック HRESULT[呼び出し](#invoke)([IWebView2WebView](IWebView2WebView.md) * webview、[IWebView2WebMessageReceivedEventArgs](IWebView2WebMessageReceivedEventArgs.md) * args)
