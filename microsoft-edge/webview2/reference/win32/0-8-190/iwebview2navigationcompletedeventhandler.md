...
---
# 0.8.355-インターフェイス IWebView2NavigationCompletedEventHandler 
...
> パブリック HRESULT[呼び出し](#invoke)([IWebView2WebView](IWebView2WebView.md) * webview、[IWebView2NavigationCompletedEventArgs](IWebView2NavigationCompletedEventArgs.md) * args)
