...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>locations</td>
            <td><a href="#location"><code class="flyout">Location[]</code></a></td>
            <td>このブレークポイントが追加時に解決された場所の一覧。</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>reason</td>
            <td><code class="flyout">string</code> <br/> <i>使用できる値: ブレークポイント、ステップ、例外、その他</i></td>
            <td>一時停止の理由。</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        <tr>
            <td>型</td>
            <td><code class="flyout">string</code> <br/> <i>使用できる値: global、local、with、closure、catch、block、script、eval、module</i></td>
            <td>スコープの種類。</td>
        </tr>
        <tr>
            <td>object</td>
