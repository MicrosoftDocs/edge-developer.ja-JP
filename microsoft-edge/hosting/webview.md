...
*   適切に調整された webview コンテンツイベントを提供します。  
    ...
    | WebView DOM イベント | 説明 |  
    |:--- |:--- |  
    | [MSWebViewNavigationStarting](#mswebviewnavigationstarting) | WebView でナビゲートが開始されていることを示します。  |  
    ...
    | [MSWebViewNavigationCompleted](#mswebviewnavigationcompleted) | ナビゲーションが完了しており、すべてのメディア要素がレンダリングされていることを示します。  |  
    | [MSWebViewUnviewableContentIdentified](#mswebviewunviewablecontentidentified) | WebView でコンテンツが HTML ではなかったことが検出されました。  |  
...
|  |  |  
|:---|:--- |  
| **インターフェイス** | [NavigationEventWithReferrer](./webview/NavigationEventWithReferrer.md) |  
| **同期** | はい |  
| **バブル** | なし |  
| **取り消し可能な** | あり |  
