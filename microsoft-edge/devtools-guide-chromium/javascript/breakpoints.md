...
1.  [ **条件付きブレークポイントの追加**] を選びます。  ダイアログがコード行の下に表示されます。  
1.  ダイアログに条件を入力します。  
1.  `Enter`ブレークポイントをアクティブ化する場合に選択します。  [行番号] 列の横にあるアイコン。  
...
1.  要素を右クリックします。  
1.  [ **中断] に**カーソルを合わせ、[ **サブツリーの変更**]、[属性の **変更**]、または [ **ノードの削除**] を選択します。  
...
1.  [ **ソース** ] タブをクリックします。  
1.  [ **例外に対して一時停止** ] を選択します (例外がある場合は ![ 一時停止 ][ImagePauseOnExceptionsIcon] します)。  有効にすると、アイコンが青色に変わります。  
