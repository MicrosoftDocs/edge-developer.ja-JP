...
この実験では、**要素** ツールで**アクセシビリティ ツリー ビュー全体**を提供します。  [[アクセシビリティ]][DevtoolsAccessibilityReferenceTheAccessibilityPane] ウィンドウ には部分的なアクセシビリティ ツリー ビューが表示され、ルート ノードから検査されたノードへの直接の祖先チェーンが表示されます。  
